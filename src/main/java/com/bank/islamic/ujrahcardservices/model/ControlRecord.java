package com.bank.islamic.ujrahcardservices.model;
...
/**
 * The BIAN control record for this service domain: "Ujrah Card Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Ujrah Card Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Ujrah Card Facility Fulfillment Arrangement";
